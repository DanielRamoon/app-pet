...
export default function ErrorModal(props: { errorMessage: string }) {
	...
	const onAnimationFinish = () => {
		if (showModal) {
			setTimeout(() => {
				setShowModal(false);
				Alert.alert(i18n.get("error"), props.errorMessage);
			}, 250);
		}
	};
			...
			<Modal.Content width="5/6">
				...
				<Modal.Body style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "100%" }}>
					<LottieView
						...
						source={require("@assets/lottie/14651-error-animation.json")}
